...
!     SIDTIM from NOVAS
    ...
    if (Iref /= 0 .and. SunElev>=0D0) then
...
!           Times(9) = Astronomical twilight in evening
    ...
    Delta = 5.D-6  ! precision of angle
    Del = 0.08D0 ! 6 minutes of time
