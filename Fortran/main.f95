...
subroutine SunMoonCalendar(Location,Iyear,CalenType,Geo,airModel,&
 ...
 15         FORMAT(5X,I4,6X,I4,5X,I4,5X,'---------Twilight---------',8X,'Sun',18X,'Noon',16X,'Sun ',&
                  ...
                  'Set-Azimuth',6X,'Astronomical Nautical  Civic',5X,'Rise-Azimuth',9X,'Set_Azimuth'&
                   ,7X,'Phases')
...
!     N IS THE ORDER OF THE INTERPOLATION POLYNOMIAL
      ...
      Function Visibility(VisiStat)

          character(40) :: Visibility
          integer :: VisiStat

          select case (VisiStat)
          case(1)
              Visibility = "Age or Lag, Moon is not Visible"
          case(2)
              Visibility = "Moon is not bright enough, not visible"
          case(10)
              Visibility = "Moon is Visible"
          case(11)
              Visibility = "Moon is visible under perfect conditions"
          case(12)
              Visibility = "May need optical aid to find crescent"
          case(13)
              Visibility = "Will need optical aid to find crescent"
          case(14)
              Visibility = "Not visible with telescope AECL<=85"
          case(15)
              Visibility = "Moon is not visible"
          case(20)
              Visibility = "Crescent is visible by naked eye"
          case(21)
              Visibility = "Crescent is visible by optical aid"
          case(22)
              Visibility = "Crescent is visible only by optical aid"
          case(23)
              Visibility = "Crescent is not visible"
          end select

          Visibility = trim(adjustl(Visibility))
       end function
